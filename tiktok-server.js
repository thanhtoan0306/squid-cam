...
function startTikTokServer(port = process.env.PORT || 8081) {
    ...
    io.on('connection', (socket) => {
        ...
        socket.on('setUniqueId', (uniqueId, options) => {
            ...
            try {
                tiktokConnectionWrapper = new TikTokConnectionWrapper(uniqueId = 'locfuho1995', options = {}, true);
            ...
            const events = ['roomUser', 'member', 'chat', 'gift', 'social', 'like', 'questionNew', 'linkMicBattle', 'linkMicArmies', 'liveIntro', 'emote', 'envelope', 'subscribe'];
